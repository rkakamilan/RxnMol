"""
MPNN Proxy Model for Molecular Property Prediction.

This module provides the Message Passing Neural Network (MPNN) architecture
used for molecular property prediction (e.g., sEH binding affinity, CB1 docking).

The code is adapted from Bengio et al. (2021), "Flow Network based Generative
Models for Non-Iterative Diverse Candidate Generation":
    - Original: https://github.com/GFNOrg/synflownet
    - SynFlowNet fork: https://github.com/mirunacrt/synflownet

This implementation:
    - Provides the MPNNet architecture for graph-based molecular prediction
    - Includes mol2graph() for converting RDKit molecules to PyTorch Geometric format
    - Supports loading the original sEH proxy model weights
    - Can be used to train custom proxy models for other targets (e.g., CB1)
"""
